...
function DefineInterface_bp3doc_uk_(id,mystore){
...
var grid_bp3doc_ukfld;
    ...
    if( grid_bp3doc_ukfld.parentid=='{00000000-0000-0000-0000-000000000000}') {return;}
   	if(CheckOperation('bp3doc.edit')!=0){
                var edit = Ext.create('EditWindow_bp3doc_ukfld');
...
var p1;
    ...
    function onAddClick(){
   	if(CheckOperation('bp3doc.edit')!=0){
                var edit = Ext.create('EditWindow_bp3doc_uk');
 ...
 p1=   new Ext.grid.Panel({
        ...
        columns: [
{text: "Раздел", width:200, dataIndex: 'ukstore_grid', sortable: true}
            ,
...
function DefineForms_bp3doc_uk_(){


Ext.define('Form_bp3doc_uk', {
extend:  'Ext.form.Panel',
alias: 'widget.f_bp3doc_uk',
...
editable: false,
listeners:{  select: function ( combo, records, eOpts ) {combo.up('form' ).activeRecord.set('ukstore', records[0].get('id'));}  },
...
Ext.define('EditWindow_bp3doc_uk', {
...
Ext.define('Form_bp3doc_ukfld', {
extend:  'Ext.form.Panel',
alias: 'widget.f_bp3doc_ukfld',
initComponent: function(){
    this.addEvents('create');
    Ext.apply(this,{
        activeRecord: null,
...
Ext.define('EditWindow_bp3doc_ukfld', {
    extend:  'Ext.window.Window',
    maxHeight: 181,
    maxWidth: 900,
    autoScroll:true,
