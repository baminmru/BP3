...
function DefineInterface_iu_rcfg_mod_admn(id,mystore){
...
local: true 
 ...
 var p1;
    ...
    function onAddClick(){
   	if(CheckOperation('iu_rcfg.edit')!=0){
                var edit = Ext.create('EditWindow_iu_rcfg_modadmn');
...
function DefineForms_iu_rcfg_mod_admn(){


Ext.define('Form_iu_rcfg_modadmn', {
extend:  'Ext.form.Panel',
alias: 'widget.f_iu_rcfg_modadmn',
...
Ext.define('EditWindow_iu_rcfg_modadmn', {
