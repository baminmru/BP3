...
function DefineInterface_iu_rcfg_mod_read(id,mystore){
...
local: true 
 ...
 var p1;
    ...
    function onAddClick(){
   	if(CheckOperation('iu_rcfg.edit')!=0){
                var edit = Ext.create('EditWindow_iu_rcfg_modread');
...
function DefineForms_iu_rcfg_mod_read(){


Ext.define('Form_iu_rcfg_modread', {
extend:  'Ext.form.Panel',
alias: 'widget.f_iu_rcfg_modread',
...
Ext.define('EditWindow_iu_rcfg_modread', {
