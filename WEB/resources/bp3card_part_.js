...
function DefineInterface_bp3card_part_(id,mystore){

var groupingFeature_bp3card_part = Ext.create('Ext.grid.feature.Grouping',{
groupByText:  'Группировать по этому полю',
showGroupsText:  'Показать группировку'
});
var filterFeature_bp3card_part = {
...
local: true 
 ...
 var p1;
    function onDeleteConfirm(selection){
      if (selection) {
        Ext.Ajax.request({
            url:    rootURL+'index.php/c_bp3card_part/deleteRow',
            method:  'POST',
    		params: { 
    				bp3card_partid: selection.get('bp3card_partid')
    				}
    	});
    ...
    function onAddClick(){
   	if(CheckOperation('bp3card.edit')!=0){
                var edit = Ext.create('EditWindow_bp3card_part');
                p1.store.insert(0, new model_bp3card_part());
 ...
 p1=   new Ext.grid.Panel(
      ...
      stateful:stateFulSystem,
       stateId:  'bp3card_part',
        iconCls:  'icon-grid',
        frame: true,
        instanceid: '',
        features: [groupingFeature_bp3card_part,filterFeature_bp3card_part],
          dockedItems: [{
                xtype:  'toolbar',
                items: [
                {
        ...
        columns: [
{text: "Раздел документа", width:200, dataIndex: 'struct_grid', sortable: true}
            ,
{text: "Разрешено добавлять", width:80, dataIndex: 'allowadd_grid', sortable: true}
            ,
{text: "Разрешено удалять", width:80, dataIndex: 'allowdelete_grid', sortable: true}
            ,
{text: "Разрешен просмотр", width:80, dataIndex: 'allowread_grid', sortable: true}
            ,
{text: "Разрешено изменять", width:80, dataIndex: 'allowedit_grid', sortable: true}
            ,
...
function DefineForms_bp3card_part_(){


Ext.define('Form_bp3card_part', {
extend:  'Ext.form.Panel',
alias: 'widget.f_bp3card_part',
...
emptyText:      '',
name:   'allowedit_grid',
itemId:   'allowedit_grid',
listeners:{  select: function ( combo, records, eOpts ) {combo.up('form' ).activeRecord.set('allowedit', records[0].get('value'));}  },
...
allowBlank:false
    ...
    onSave: function(){
        ...
        if (form.isValid()) {
            ...
            Ext.Ajax.request({
                url: rootURL+'index.php/c_bp3card_part/setRow',
                method:  'POST',
                params: { 
                    instanceid: this.instanceid
                    ,bp3card_partid: active.get('bp3card_partid')
	            ...
	            if(res.success==false){
                    ...
                    if(active.get('bp3card_partid')==''){
               			active.set('bp3card_partid',res.data['bp3card_partid']);
                    }
    ...
    onReset: function(){
        if(this.activeRecord.get('bp3card_partid')==''){
...
Ext.define('EditWindow_bp3card_part', {
