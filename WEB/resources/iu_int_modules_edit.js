...
function DefineInterface_iu_int_modules_edit(id,mystore){

var groupingFeature_iu_int_modules = Ext.create('Ext.grid.feature.Grouping',{
groupByText:  'Группировать по этому полю',
showGroupsText:  'Показать группировку'
});
var filterFeature_iu_int_modules = {
...
local: true 
 ...
 var p1;
    function onDeleteConfirm(selection){
      if (selection) {
        Ext.Ajax.request({
            url:    rootURL+'index.php/c_iu_int_modules/deleteRow',
            method:  'POST',
    		params: { 
    				iu_int_modulesid: selection.get('iu_int_modulesid')
    				}
    	});
    ...
    function onAddClick(){
   	if(CheckOperation('iu_int.edit')!=0){
                var edit = Ext.create('EditWindow_iu_int_modulesedit');
                p1.store.insert(0, new model_iu_int_modules());
 ...
 p1=   new Ext.grid.Panel(
        ...
        frame: true,
        instanceid: '',
        features: [groupingFeature_iu_int_modules,filterFeature_iu_int_modules],
          dockedItems: [{
                xtype:  'toolbar',
                items: [
                {
...
function DefineForms_iu_int_modules_edit(){


Ext.define('Form_iu_int_modulesedit', {
extend:  'Ext.form.Panel',
alias: 'widget.f_iu_int_modulesedit',
...
allowBlank:false
    ...
    onSave: function(){
        ...
        if (form.isValid()) {
            ...
            Ext.Ajax.request({
                url: rootURL+'index.php/c_iu_int_modules/setRow',
                method:  'POST',
                params: { 
                    instanceid: this.instanceid
                    ,iu_int_modulesid: active.get('iu_int_modulesid')
	            ...
	            if(res.success==false){
                    ...
                    if(active.get('iu_int_modulesid')==''){
               			active.set('iu_int_modulesid',res.data['iu_int_modulesid']);
                    }
    ...
    onReset: function(){
        if(this.activeRecord.get('iu_int_modulesid')==''){
...
Ext.define('EditWindow_iu_int_modulesedit', {
