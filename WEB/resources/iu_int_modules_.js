...
function DefineInterface_iu_int_modules_(id,mystore){
...
local: true 
 ...
 var p1;
    ...
    function onAddClick(){
   	if(CheckOperation('iu_int.edit')!=0){
                var edit = Ext.create('EditWindow_iu_int_modules');
...
function DefineForms_iu_int_modules_(){


Ext.define('Form_iu_int_modules', {
extend:  'Ext.form.Panel',
alias: 'widget.f_iu_int_modules',
...
Ext.define('EditWindow_iu_int_modules', {
