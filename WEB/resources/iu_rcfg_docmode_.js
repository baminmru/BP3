...
function DefineInterface_iu_rcfg_docmode_(id,mystore){
...
local: true 
 ...
 var p1;
    ...
    function onAddClick(){
   	if(CheckOperation('iu_rcfg.edit')!=0){
                var edit = Ext.create('EditWindow_iu_rcfg_docmode');
...
function DefineForms_iu_rcfg_docmode_(){


Ext.define('Form_iu_rcfg_docmode', {
extend:  'Ext.form.Panel',
alias: 'widget.f_iu_rcfg_docmode',
...
Ext.define('EditWindow_iu_rcfg_docmode', {
