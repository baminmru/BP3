...
function DefineInterface_iu_int_modules_read(id,mystore){
...
local: true 
 ...
 var p1;
    ...
    function onAddClick(){
   	if(CheckOperation('iu_int.edit')!=0){
                var edit = Ext.create('EditWindow_iu_int_modulesread');
...
function DefineForms_iu_int_modules_read(){


Ext.define('Form_iu_int_modulesread', {
extend:  'Ext.form.Panel',
alias: 'widget.f_iu_int_modulesread',
...
Ext.define('EditWindow_iu_int_modulesread', {
