...
function DefineInterface_bp3doc_store_test(id,treestore_bp3doc_store){
...
var grid_bp3doc_field;
    ...
    if( grid_bp3doc_field.parentid=='{00000000-0000-0000-0000-000000000000}') {return;}
   	if(CheckOperation('bp3doc.edit')!=0){
                var edit = Ext.create('EditWindow_bp3doc_fieldtest');
...
var p1;
    ...
    function onDeleteClick(){
     ...
     function onAddRootClick(){
   	if(CheckOperation('bp3doc.edit')!=0){
                var edit = Ext.create('EditWindow_bp3doc_storetest');
...
p1=    new Ext.tree.Panel({
        ...
        columns: [
{xtype: 'treecolumn',text: "№ п/п", width: 450, dataIndex: 'sequence', sortable: true}
            ,
...
{text: "Главный раздел", width: 60, dataIndex: 'isdocinstance_grid', sortable: true}
            ,
{text: "Архивировать вместо удаления", width: 60, dataIndex: 'usearchiving_grid', sortable: true}
            ,
{text: "Не записывать в журнал", width: 60, dataIndex: 'nolog_grid', sortable: true}
            ,
{text: "Шаблон для краткого отображения",width: 160, dataIndex: 'shablonbrief', sortable: true}
            ,
{text: "Вести журнал изменений", width: 60, dataIndex: 'usechangelog_grid', sortable: true}
            ,
{text: "Правило составления BRIEF поля",width: 160, dataIndex: 'rulebrief', sortable: true}
        ]
,
...
function DefineForms_bp3doc_store_test(){


Ext.define('Form_bp3doc_storetest', {
extend:  'Ext.form.Panel',
alias: 'widget.f_bp3doc_storetest',
...
Ext.define('EditWindow_bp3doc_storetest', {
    ...
    title:  'Раздел',
    items:[{
        xtype:  'f_bp3doc_storetest'
	}]
	});

Ext.define('Form_bp3doc_fieldtest', {
extend:  'Ext.form.Panel',
alias: 'widget.f_bp3doc_fieldtest',
initComponent: function(){
    this.addEvents('create');
    Ext.apply(this,{
        activeRecord: null,
...
onTrigger1Click : function(){
		this.collapse();
		this.clearValue();
		this.up('form' ).activeRecord.set('fieldtype',null );
},
onTrigger2Click : function(){ 
		if(this.isExpanded) {
			this.collapse(); 
...
Ext.define('EditWindow_bp3doc_fieldtest', {
    extend:  'Ext.window.Window',
    maxHeight: 1007,
    maxWidth: 900,
    autoScroll:true,
