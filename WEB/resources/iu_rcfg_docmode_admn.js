...
function DefineInterface_iu_rcfg_docmode_admn(id,mystore){
...
local: true 
 ...
 var p1;
    ...
    function onAddClick(){
   	if(CheckOperation('iu_rcfg.edit')!=0){
                var edit = Ext.create('EditWindow_iu_rcfg_docmodeadmn');
...
function DefineForms_iu_rcfg_docmode_admn(){


Ext.define('Form_iu_rcfg_docmodeadmn', {
extend:  'Ext.form.Panel',
alias: 'widget.f_iu_rcfg_docmodeadmn',
...
editable: false,
listeners:{  select: function ( combo, records, eOpts ) {combo.up('form' ).activeRecord.set('the_document', records[0].get('id'));}  },
...
Ext.define('EditWindow_iu_rcfg_docmodeadmn', {
