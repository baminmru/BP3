...
function DefineInterface_bp3app_info_(id,mystore,selection){
...
var p1_valid=false;
     function onSave(close_after_save,callaftersave){
        ...
        if (form.isValid()) {
            ...
            Ext.Ajax.request({
                url: rootURL+'index.php/c_bp3app_info/setRow',
                method:  'POST',
                params: { 
                    instanceid: p1.instanceid
                    ,bp3app_infoid: active.get('bp3app_infoid')
	            ...
	            if(res.success==false){
                    ...
                    if(active.get('bp3app_infoid')==''){
               			active.set('bp3app_infoid',res.data['bp3app_infoid']);
                    }
        		   /* Ext.MessageBox.show({
                        title:  'Подтверждение',
                   ...
                   if(selection){
                     Ext.Ajax.request({
                        url: rootURL+'index.php/c_v_autobp3app_info/getRows?&filter=[{"property":"bp3app_infoid","value":"'+ active.get('bp3app_infoid') + '"}]',
                        method:     'GET',
                        success: function(response){
...
function DefineForms_bp3app_info_(){


Ext.define('Form_bp3app_info', {
extend:  'Ext.form.Panel',
alias: 'widget.f_bp3app_info',
...
allowBlank:false
    ...
    onReset: function(){
        if(this.activeRecord.get('bp3app_infoid')==''){
...
Ext.define('EditWindow_bp3app_info', {
