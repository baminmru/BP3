...
''' <summary>
''' Внутренняя переменная для раздела Колонки журнала
''' </summary>
''' <remarks>
'''
''' </remarks>
  Private m_bp3list_col As bp3list_col_col


''' <summary>
'''Свойство для доступа к строкам раздела Колонки журнала
''' </summary>
''' <remarks>
'''
''' </remarks>
        Public ReadOnly Property bp3list_col() As bp3list_col_col
            Get
                If m_bp3list_col Is Nothing Then
                    m_bp3list_col = New bp3list_col_col
                    m_bp3list_col.Application = Me
                    m_bp3list_col.Parent = Me
                    m_bp3list_col.Refresh()
                End If
                bp3list_col = m_bp3list_col
            End Get
        End Property


''' <summary>
''' Внутренняя переменная для раздела Журнал
''' </summary>
''' <remarks>
'''
''' </remarks>
  Private m_bp3list_def As bp3list_def_col


''' <summary>
'''Свойство для доступа к строкам раздела Журнал
''' </summary>
''' <remarks>
'''
''' </remarks>
        Public ReadOnly Property bp3list_def() As bp3list_def_col
            Get
                If m_bp3list_def Is Nothing Then
                    m_bp3list_def = New bp3list_def_col
                    m_bp3list_def.Application = Me
                    m_bp3list_def.Parent = Me
                    m_bp3list_def.Refresh()
                End If
                bp3list_def = m_bp3list_def
            End Get
        End Property


''' <summary>
''' Внутренняя переменная для раздела Группа полей фильтра
''' </summary>
''' <remarks>
'''
''' </remarks>
  Private m_bp3list_filter As bp3list_filter_col


''' <summary>
'''Свойство для доступа к строкам раздела Группа полей фильтра
''' </summary>
''' <remarks>
'''
''' </remarks>
        Public ReadOnly Property bp3list_filter() As bp3list_filter_col
            Get
                If m_bp3list_filter Is Nothing Then
                    m_bp3list_filter = New bp3list_filter_col
                    m_bp3list_filter.Application = Me
                    m_bp3list_filter.Parent = Me
                    m_bp3list_filter.Refresh()
                End If
                bp3list_filter = m_bp3list_filter
            End Get
        End Property
...
''' </remarks>
        ...
        FindInCollections = Nothing
            ...
            mFindInCollections = bp3list_def.FindObject(Table, InstID)
            if not mFindInCollections is nothing then return mFindInCollections
            mFindInCollections = bp3list_col.FindObject(Table, InstID)
            if not mFindInCollections is nothing then return mFindInCollections
            mFindInCollections = bp3list_filter.FindObject(Table, InstID)
            if not mFindInCollections is nothing then return mFindInCollections
        End Function
...
''' </remarks>
        Protected Overrides Sub XMLLoadCollections(ByVal node As System.Xml.XmlNode, Optional ByVal LoadMode As Integer = 0)
            ...
            e_list = node.SelectNodes("bp3list_def_COL")
            bp3list_def.XMLLoad(e_list, LoadMode)
            e_list = node.SelectNodes("bp3list_col_COL")
            bp3list_col.XMLLoad(e_list, LoadMode)
            e_list = node.SelectNodes("bp3list_filter_COL")
            bp3list_filter.XMLLoad(e_list, LoadMode)
        End Sub
...
''' </remarks>
        Public Overrides Sub XMLSaveCollections(ByVal node As System.Xml.XmlElement, ByVal Xdom As System.Xml.XmlDocument)
            bp3list_def.XMLSave(node, Xdom)
            bp3list_col.XMLSave(node, Xdom)
            bp3list_filter.XMLSave(node, Xdom)
        End Sub
...
Public Overrides Sub BatchUpdate()
    bp3list_def.BatchUpdate
    bp3list_col.BatchUpdate
    bp3list_filter.BatchUpdate
End Sub
    End Class
End Namespace
