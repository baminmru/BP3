...
Public Class Session
    ...
    Private mvarMap As BP3.NamedValues
    ...
    Public Property XmlFile() As String
        Get
            If mXmlFile = "" Then
                mXmlFile = System.IO.Path.GetDirectoryName(Me.GetType().Assembly.Location) & "\BP3_sites.xml"
            End If
            Return mXmlFile
        End Get
        Set(ByVal Value As String)
    ...
    Friend ReadOnly Property MAP() As BP3.NamedValues
        Get
            Return mvarMap
        End Get
    End Property
    ...
    Private Function GetProviderByName(ByVal name As String) As BP3.DBProvider
        Select Case UCase(name)
            Case "SQLOLEDB"
                Return New BP3.SQLDBProvider
                'Case "MSDAORA"
                '    Return New BP3.ORADBProvider
                'Case "MSDAORA.1"
                '    Return New BP3.ORADBProvider
            Case "MYSQL"
                Return New BP3.MYSQLDBProvider
            Case Else
                Return New BP3.DBProvider
        End Select
    End Function
    ...
    Public Function GetProvider() As BP3.DBProvider
        Try
            Dim p As BP3.DBProvider
            p = GetProviderByName(mProvider)
            Return p
    ...
    Public Function IntegratedLogin() As Boolean
        ...
        Try
            ...
            Dim p As BP3.NamedValues



            p = New BP3.NamedValues
    ...
    '[IN]   Values , тип параметра: BP3.NamedValues  - коллекция значений полей
    'Returns:
    ' Boolean, семантика результата:
    '   true  -сохранено
    '   false -ошибка
    ...
    Public Function SaveRow(ByVal Table As String, ByVal RowID As Guid, ByVal ParentID As Guid, ByVal Values As BP3.NamedValues) As Boolean
        Dim nv As BP3.NamedValues
        Dim I As Integer
        nv = New BP3.NamedValues
    ...
    Public Function SaveRow2(ByVal Table As String, ByVal RowID As Guid, ByVal ParentID As Guid, ByVal Values As BP3.NamedValues, ByVal InstanceID As System.Guid) As Boolean
        Dim nv As BP3.NamedValues
        Dim I As Integer
        nv = New BP3.NamedValues
    ...
    '[IN]   Values , тип параметра: BP3.NamedValues  - список значений параметров
    'Returns:
    ' Boolean, семантика результата:
    '   true  -удача
    '   false -ошибка
    ...
    Public Function Exec(ByVal Method As String, ByVal Values As BP3.NamedValues) As Boolean
