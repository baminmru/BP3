...
Namespace Document
    Public MustInherit Class DocCollection_Base
        ...
        Public Function GetDataTable() As DataTable
            ...
            For i = 1 To Count
                CType(mCol.Item(i), BP3.Document.DocRow_Base).FillDataTable(dt)
            Next
            ...
            Try
                If mCol.Count > 0 Then
                    If Not mCol.Contains(ID2String(LID.ToString())) Then
                        ...
                        Return o
                    Else
                        Return CType(mCol.Item(ID2String(LID.ToString())), BP3.Document.DocRow_Base)
            ...
            Try
                ...
                If IsNumeric(ID) Then
                    If SortDV Is Nothing Then
                        Return CType(mCol.Item(ID), BP3.Document.DocRow_Base)
                    Else
                        If SortDV.Count <> mCol.Count Then
                            ReSort()
                        End If

                        Return CType(mCol.Item(ID2String(SortDV(CType(ID, Integer) - 1)("ID").ToString())), BP3.Document.DocRow_Base)
                    End If
...
OK:
        ...
        Public Sub Refresh()
            ...
            If Not rs Is Nothing Then ' wrong database structure
                For idx = 0 To rs.Rows.Count - 1
                    ...
                    If Not mcol2.Contains(ID2String(tID.ToString)) Then
                        ...
                        End If
                    Else
                        o = CType(mcol2.Item(ID2String(tID.ToString)), BP3.Document.DocRow_Base)
                        If Application.AutoLoadPart Then
                            o.CleanFields()
                            o.Unpack(rs.Rows(idx))
                            'MLF'
            ...
            For idx = 1 To mcol2.Count
                o = CType(mcol2.Item(idx), BP3.Document.DocRow_Base)
                o.Dispose()
            Next
            mcol2 = Nothing
        End Sub
        ...
        Private Sub CheckLock()
            ...
            Try
                ...
                m_IsLocked = CType(nv.Item("ISLocked").Value, BP3.Session.LockStyle)
                nv = Nothing
                LastCheckTime = Now
            Catch
            End Try
