...
Namespace Document
    ...
    Public MustInherit Class Doc_Base
        ...
        Private m_Manager As BP3.Manager
        ...
        Private m_IsLocked As BP3.Session.LockStyle
        ...
        Public Property Manager() As BP3.Manager
            Get
                Return m_Manager
            End Get
            Set(ByVal m As BP3.Manager)
        ...
        Public ReadOnly Property Session() As BP3.Session
            Get
        ...
        Public Function FindRowObject(ByVal StrID As String, ByVal RowID As Guid) As DocRow_Base
            ...
            Try
                ...
                If findCash.Contains(StrID & ID2String(RowID.ToString())) Then
                    m_FindObject = CType(findCash.Item(StrID & ID2String(RowID.ToString())), BP3.Document.DocRow_Base)
                End If
                        ...
                        If rpl.Item(1).RowID.Equals(ID) Then
                            ...
                            Else
                                For i = 3 To rpl.Count
                                    Rowobj = CType(Rowobj.FindObject(rpl.Item(i).PartName, rpl.Item(i).RowID.ToString), BP3.Document.DocRow_Base)
                                Next
                            End If
        ...
        Public Function FindObject(ByVal Table As String, ByVal RowID As String) As DocRow_Base
            ...
            Try
                If findCash.Contains(Table & ID2String(RowID)) Then
                    m_FindObject = CType(findCash.Item(Table & ID2String(RowID)), BP3.Document.DocRow_Base)
                Else
                    m_FindObject = Nothing
                End If
                If Not m_FindObject Is Nothing Then
        ...
        Public Sub Secure(ByVal SecurityStyleID As Guid)
            Dim nv As BP3.NamedValues
            nv = New BP3.NamedValues
        ...
        Public Overrides ReadOnly Property CanChange() As Boolean
            Get
                ...
                End If
                If test Then
                    test = (IsLocked < BP3.Session.LockStyle.ExternalLockSession)
                End If
                Return test
            End Get
        ...
        Public Property IsLocked() As BP3.Session.LockStyle
            Get
                If m_IsLocked <> BP3.Session.LockStyle.LockSession And m_IsLocked <> BP3.Session.LockStyle.LockPermanent Then CheckLock()
                Return m_IsLocked
            End Get
            Set(ByVal Value As BP3.Session.LockStyle)
                m_IsLocked = Value
            End Set
        ...
        Private Sub CheckLock()
            ...
            Dim nv As BP3.NamedValues, LockType As Long
            nv = New BP3.NamedValues
            nv.Add("CURSESSION", Session.GetProvider.ID2Param(Session.SessionID), Session.GetProvider.ID2DbType(), Session.GetProvider.ID2Size())
            nv.Add("ROWID", Session.GetProvider.ID2Param(ID), Session.GetProvider.ID2DbType(), Session.GetProvider.ID2Size())
            ...
            Try
                ...
                m_IsLocked = CType(Int16.Parse(nv.Item("ISLocked").Value.ToString), BP3.Session.LockStyle)
                nv = Nothing
                LastCheckTime = Now
            Catch
            End Try
        ...
        Public Function LockResource(Optional ByVal Permanent As Boolean = False) As Boolean
            ...
            Try
                ...
                If OK Then
                    If Permanent Then m_IsLocked = BP3.Session.LockStyle.LockPermanent Else m_IsLocked = BP3.Session.LockStyle.LockSession
                Else
                    m_IsLocked = BP3.Session.LockStyle.NoLock
                End If
                Return (True)
            Catch ex As System.Exception
                nv = Nothing
        ...
        Public Function CanLock() As Boolean
            Dim nv As BP3.NamedValues, notLocked As Long
            nv = New BP3.NamedValues
            nv.Add("CURSESSION", Session.GetProvider.ID2Param(Session.SessionID), Session.GetProvider.ID2DbType(), Session.GetProvider.ID2Size())
            nv.Add("INSTANCEID", Session.GetProvider.ID2Param(ID), Session.GetProvider.ID2DbType(), Session.GetProvider.ID2Size())
        ...
        Public Sub XMLLoad(ByVal node As XmlNode, Optional ByVal LoadMode As Integer = 0)
            ...
            Try
                ...
                m_IsLocked = CType(Int16.Parse(anode.Attributes("IsLocked").Value), BP3.Session.LockStyle)
