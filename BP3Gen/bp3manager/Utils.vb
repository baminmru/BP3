...
Public Class Utils
    ...
    Public Shared Function GUID2String(ByVal aSession As BP3.Session, ByVal gIn As System.Guid) As String
    ...
    Public Shared Function CopyObject(ByRef ObjectIn As Document.Doc_Base, ByRef Manager As BP3.Manager) As Document.Doc_Base
        Try
