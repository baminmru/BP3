...
''' <summary>
''' Внутренняя переменная для раздела Модули
''' </summary>
''' <remarks>
'''
''' </remarks>
  Private m_BP3APP_MODULES As BP3APP_MODULES_col


''' <summary>
'''Свойство для доступа к строкам раздела Модули
''' </summary>
''' <remarks>
'''
''' </remarks>
        Public ReadOnly Property BP3APP_MODULES() As BP3APP_MODULES_col
            Get
                If m_BP3APP_MODULES Is Nothing Then
                    m_BP3APP_MODULES = New BP3APP_MODULES_col
                    m_BP3APP_MODULES.Application = Me
                    m_BP3APP_MODULES.Parent = Me
                    m_BP3APP_MODULES.Refresh()
                End If
                BP3APP_MODULES = m_BP3APP_MODULES
            End Get
        End Property


''' <summary>
''' Внутренняя переменная для раздела Меню
''' </summary>
''' <remarks>
'''
''' </remarks>
  Private m_BP3APP_MENU As BP3APP_MENU_col


''' <summary>
'''Свойство для доступа к строкам раздела Меню
''' </summary>
''' <remarks>
'''
''' </remarks>
        Public ReadOnly Property BP3APP_MENU() As BP3APP_MENU_col
            Get
                If m_BP3APP_MENU Is Nothing Then
                    m_BP3APP_MENU = New BP3APP_MENU_col
                    m_BP3APP_MENU.Application = Me
                    m_BP3APP_MENU.Parent = Me
                    m_BP3APP_MENU.Refresh()
                End If
                BP3APP_MENU = m_BP3APP_MENU
            End Get
        End Property


''' <summary>
''' Внутренняя переменная для раздела Тип права
''' </summary>
''' <remarks>
'''
''' </remarks>
  Private m_BP3APP_RIGTHTYPE As BP3APP_RIGTHTYPE_col


''' <summary>
'''Свойство для доступа к строкам раздела Тип права
''' </summary>
''' <remarks>
'''
''' </remarks>
        Public ReadOnly Property BP3APP_RIGTHTYPE() As BP3APP_RIGTHTYPE_col
            Get
                If m_BP3APP_RIGTHTYPE Is Nothing Then
                    m_BP3APP_RIGTHTYPE = New BP3APP_RIGTHTYPE_col
                    m_BP3APP_RIGTHTYPE.Application = Me
                    m_BP3APP_RIGTHTYPE.Parent = Me
                    m_BP3APP_RIGTHTYPE.Refresh()
                End If
                BP3APP_RIGTHTYPE = m_BP3APP_RIGTHTYPE
            End Get
        End Property
...
'''
''' </remarks>
  Private m_BP3APP_INFO As BP3APP_INFO_col
...
'''
''' </remarks>
        Public ReadOnly Property BP3APP_INFO() As BP3APP_INFO_col
            Get
                If m_BP3APP_INFO Is Nothing Then
                    m_BP3APP_INFO = New BP3APP_INFO_col
                    m_BP3APP_INFO.Application = Me
                    m_BP3APP_INFO.Parent = Me
                    m_BP3APP_INFO.Refresh()
                End If
                BP3APP_INFO = m_BP3APP_INFO
            End Get
        End Property
...
''' </remarks>
        ...
        Public Overrides Sub Dispose()
            BP3APP_MENU.Dispose()
            BP3APP_INFO.Dispose()
            BP3APP_MODULES.Dispose()
            BP3APP_RIGTHTYPE.Dispose()
        End Sub
...
''' </remarks>
        ...
        FindInCollections = Nothing
            ...
            mFindInCollections = BP3APP_MENU.FindObject(Table, InstID)
            if not mFindInCollections is nothing then return mFindInCollections
            mFindInCollections = BP3APP_INFO.FindObject(Table, InstID)
            if not mFindInCollections is nothing then return mFindInCollections
            mFindInCollections = BP3APP_MODULES.FindObject(Table, InstID)
            if not mFindInCollections is nothing then return mFindInCollections
            mFindInCollections = BP3APP_RIGTHTYPE.FindObject(Table, InstID)
            if not mFindInCollections is nothing then return mFindInCollections
        End Function
...
''' </remarks>
        Protected Overrides Sub XMLLoadCollections(ByVal node As System.Xml.XmlNode, Optional ByVal LoadMode As Integer = 0)
            ...
            e_list = node.SelectNodes("BP3APP_MENU_COL")
            BP3APP_MENU.XMLLoad(e_list, LoadMode)
            e_list = node.SelectNodes("BP3APP_INFO_COL")
            BP3APP_INFO.XMLLoad(e_list, LoadMode)
            e_list = node.SelectNodes("BP3APP_MODULES_COL")
            BP3APP_MODULES.XMLLoad(e_list, LoadMode)
            e_list = node.SelectNodes("BP3APP_RIGTHTYPE_COL")
            BP3APP_RIGTHTYPE.XMLLoad(e_list, LoadMode)
        End Sub
...
''' </remarks>
        Public Overrides Sub XMLSaveCollections(ByVal node As System.Xml.XmlElement, ByVal Xdom As System.Xml.XmlDocument)
            BP3APP_MENU.XMLSave(node, Xdom)
            BP3APP_INFO.XMLSave(node, Xdom)
            BP3APP_MODULES.XMLSave(node, Xdom)
            BP3APP_RIGTHTYPE.XMLSave(node, Xdom)
        End Sub
...
Public Overrides Sub BatchUpdate()
    BP3APP_MENU.BatchUpdate
    BP3APP_INFO.BatchUpdate
    BP3APP_MODULES.BatchUpdate
    BP3APP_RIGTHTYPE.BatchUpdate
End Sub
    End Class
End Namespace
