...
'''
''' </remarks>
  Private m_bp3report_def As bp3report_def_col
...
'''
''' </remarks>
        Public ReadOnly Property bp3report_def() As bp3report_def_col
            Get
                If m_bp3report_def Is Nothing Then
                    m_bp3report_def = New bp3report_def_col
                    m_bp3report_def.Application = Me
                    m_bp3report_def.Parent = Me
                    m_bp3report_def.Refresh()
                End If
                bp3report_def = m_bp3report_def
            End Get
        End Property
...
'''
''' </remarks>
  Private m_bp3report_filter As bp3report_filter_col
...
'''
''' </remarks>
        Public ReadOnly Property bp3report_filter() As bp3report_filter_col
            Get
                If m_bp3report_filter Is Nothing Then
                    m_bp3report_filter = New bp3report_filter_col
                    m_bp3report_filter.Application = Me
                    m_bp3report_filter.Parent = Me
                    m_bp3report_filter.Refresh()
                End If
                bp3report_filter = m_bp3report_filter
            End Get
        End Property
...
''' </remarks>
        ...
        Public Overrides Sub Dispose()
            bp3report_def.Dispose()
            bp3report_filter.Dispose()
        End Sub
...
''' </remarks>
        ...
        FindInCollections = Nothing
            ...
            mFindInCollections = bp3report_def.FindObject(Table, InstID)
            if not mFindInCollections is nothing then return mFindInCollections
            mFindInCollections = bp3report_filter.FindObject(Table, InstID)
            if not mFindInCollections is nothing then return mFindInCollections
        End Function
...
''' </remarks>
        Protected Overrides Sub XMLLoadCollections(ByVal node As System.Xml.XmlNode, Optional ByVal LoadMode As Integer = 0)
            ...
            e_list = node.SelectNodes("bp3report_def_COL")
            bp3report_def.XMLLoad(e_list, LoadMode)
            e_list = node.SelectNodes("bp3report_filter_COL")
            bp3report_filter.XMLLoad(e_list, LoadMode)
        End Sub
...
''' </remarks>
        Public Overrides Sub XMLSaveCollections(ByVal node As System.Xml.XmlElement, ByVal Xdom As System.Xml.XmlDocument)
            bp3report_def.XMLSave(node, Xdom)
            bp3report_filter.XMLSave(node, Xdom)
        End Sub
...
Public Overrides Sub BatchUpdate()
    bp3report_def.BatchUpdate
    bp3report_filter.BatchUpdate
End Sub
    End Class
End Namespace
