...
''' <summary>
''' Внутренняя переменная для раздела Генераторы
''' </summary>
''' <remarks>
'''
''' </remarks>
  Private m_bp3dic_gen As bp3dic_gen_col


''' <summary>
'''Свойство для доступа к строкам раздела Генераторы
''' </summary>
''' <remarks>
'''
''' </remarks>
        Public ReadOnly Property bp3dic_gen() As bp3dic_gen_col
            Get
                If m_bp3dic_gen Is Nothing Then
                    m_bp3dic_gen = New bp3dic_gen_col
                    m_bp3dic_gen.Application = Me
                    m_bp3dic_gen.Parent = Me
                    m_bp3dic_gen.Refresh()
                End If
                bp3dic_gen = m_bp3dic_gen
            End Get
        End Property
...
''' </remarks>
        ...
        FindInCollections = Nothing
            ...
            mFindInCollections = bp3dic_gen.FindObject(Table, InstID)
...
''' </remarks>
        Protected Overrides Sub XMLLoadCollections(ByVal node As System.Xml.XmlNode, Optional ByVal LoadMode As Integer = 0)
            ...
            e_list = node.SelectNodes("bp3dic_gen_COL")
            bp3dic_gen.XMLLoad(e_list, LoadMode)
        End Sub
