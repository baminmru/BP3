...
''' <summary>
''' Внутренняя переменная для раздела Тип поля
''' </summary>
''' <remarks>
'''
''' </remarks>
  Private m_bp3ft_def As bp3ft_def_col


''' <summary>
'''Свойство для доступа к строкам раздела Тип поля
''' </summary>
''' <remarks>
'''
''' </remarks>
        Public ReadOnly Property bp3ft_def() As bp3ft_def_col
            Get
                If m_bp3ft_def Is Nothing Then
                    m_bp3ft_def = New bp3ft_def_col
                    m_bp3ft_def.Application = Me
                    m_bp3ft_def.Parent = Me
                    m_bp3ft_def.Refresh()
                End If
                bp3ft_def = m_bp3ft_def
            End Get
        End Property


''' <summary>
''' Внутренняя переменная для раздела Отображение
''' </summary>
''' <remarks>
'''
''' </remarks>
  Private m_bp3ft_map As bp3ft_map_col


''' <summary>
'''Свойство для доступа к строкам раздела Отображение
''' </summary>
''' <remarks>
'''
''' </remarks>
        Public ReadOnly Property bp3ft_map() As bp3ft_map_col
            Get
                If m_bp3ft_map Is Nothing Then
                    m_bp3ft_map = New bp3ft_map_col
                    m_bp3ft_map.Application = Me
                    m_bp3ft_map.Parent = Me
                    m_bp3ft_map.Refresh()
                End If
                bp3ft_map = m_bp3ft_map
            End Get
        End Property


''' <summary>
''' Внутренняя переменная для раздела Зачения
''' </summary>
''' <remarks>
'''
''' </remarks>
  Private m_bp3ft_enums As bp3ft_enums_col


''' <summary>
'''Свойство для доступа к строкам раздела Зачения
''' </summary>
''' <remarks>
'''
''' </remarks>
        Public ReadOnly Property bp3ft_enums() As bp3ft_enums_col
            Get
                If m_bp3ft_enums Is Nothing Then
                    m_bp3ft_enums = New bp3ft_enums_col
                    m_bp3ft_enums.Application = Me
                    m_bp3ft_enums.Parent = Me
                    m_bp3ft_enums.Refresh()
                End If
                bp3ft_enums = m_bp3ft_enums
            End Get
        End Property
...
''' </remarks>
        ...
        FindInCollections = Nothing
            ...
            mFindInCollections = bp3ft_def.FindObject(Table, InstID)
            if not mFindInCollections is nothing then return mFindInCollections
            mFindInCollections = bp3ft_map.FindObject(Table, InstID)
            if not mFindInCollections is nothing then return mFindInCollections
            mFindInCollections = bp3ft_enums.FindObject(Table, InstID)
            if not mFindInCollections is nothing then return mFindInCollections
        End Function
...
''' </remarks>
        Protected Overrides Sub XMLLoadCollections(ByVal node As System.Xml.XmlNode, Optional ByVal LoadMode As Integer = 0)
            ...
            e_list = node.SelectNodes("bp3ft_def_COL")
            bp3ft_def.XMLLoad(e_list, LoadMode)
            e_list = node.SelectNodes("bp3ft_map_COL")
            bp3ft_map.XMLLoad(e_list, LoadMode)
            e_list = node.SelectNodes("bp3ft_enums_COL")
            bp3ft_enums.XMLLoad(e_list, LoadMode)
        End Sub
...
''' </remarks>
        Public Overrides Sub XMLSaveCollections(ByVal node As System.Xml.XmlElement, ByVal Xdom As System.Xml.XmlDocument)
            bp3ft_def.XMLSave(node, Xdom)
            bp3ft_map.XMLSave(node, Xdom)
            bp3ft_enums.XMLSave(node, Xdom)
        End Sub
...
Public Overrides Sub BatchUpdate()
    bp3ft_def.BatchUpdate
    bp3ft_map.BatchUpdate
    bp3ft_enums.BatchUpdate
End Sub
    End Class
End Namespace
