...
'''
''' </remarks>
        Public Property SourceView() As BP3.Document.docrow_base
            Get
                LoadFromDatabase()
...
'''
''' </remarks>
        Public Property EditCard() As BP3.Document.docrow_base
            Get
                LoadFromDatabase()
...
'''
''' </remarks>
        Public Property NewCard() As BP3.Document.docrow_base
            Get
                LoadFromDatabase()
