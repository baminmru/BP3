...
'''
''' </remarks>
    Public Class bp3list_filter_col
...
'''
''' </remarks>
        Public Function GetItem( vIndex as object ) As bp3list.bp3list_filter
            on error resume next
            GetItem = Convert.ChangeType(mybase.Item(vIndex), GetType(bp3list.bp3list_filter))
        End Function
...
'''
''' </remarks>
        Public Shadows Function Item( vIndex as object ) As bp3list.bp3list_filter
            on error resume next
...
Public Overrides Function FieldList() As String
    If mFieldList = "*" Then
       ...
       mFieldList=.ID2Base("bp3list_filterID")
