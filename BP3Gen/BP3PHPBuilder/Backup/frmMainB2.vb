...
#End Region
    ...
    'Private Sub MenuItem1_Click(sender As System.Object, e As System.EventArgs)
    '    Dim f As frmLoadBKN
    '    f = New frmLoadBKN
    '    f.ShowDialog()
    '    f = Nothing
    ...
    Private Sub mnuB2Searcher_Click(sender As System.Object, e As System.EventArgs) Handles mnuB2Searcher.Click
        Dim f As frmB2SercherMYSQL
        f = New frmB2SercherMYSQL
        f.ShowDialog()
        f = Nothing
    End Sub


    'Private Sub MenuItem1_Click_1(sender As System.Object, e As System.EventArgs) Handles MenuItem1.Click
    '    Dim f As frmLoadBKN
    '    f = New frmLoadBKN
    '    f.ShowDialog()
    '    f = Nothing
    ...
    'Private Sub mnuResolveCoords_Click(sender As System.Object, e As System.EventArgs) Handles mnuResolveCoords.Click
    '    Dim f As frmResolver
    '    f = New frmResolver
    '    f.ShowDialog()
    '    f = Nothing
    'End Sub

    'Private Sub mnuLinkPhoto_Click(sender As System.Object, e As System.EventArgs) Handles mnuLinkPhoto.Click
    '    Dim f As frmLinkPhoto
    '    f = New frmLinkPhoto
    '    f.ShowDialog()
    '    f = Nothing
    'End Sub

    Private Sub MenuItem11_Click(sender As System.Object, e As System.EventArgs) Handles mnuGenAgencyMS.Click
        Dim f As frmB2Sercher
        f = New frmB2Sercher
        f.ShowDialog()
        f = Nothing
    End Sub
    ...
    'Private Sub mnuImportEMLS_Click(sender As System.Object, e As System.EventArgs) Handles mnuImportEMLS.Click
    '    Dim F As frmEmlsImport
    '    F = New frmEmlsImport
    '    F.ShowDialog()
    '    F = Nothing
    'End Sub
