...
Partial Class frmB2Sercher
    ...
    Private Sub InitializeComponent()
        ...
        Me.textBoxOutPutFolder.Text = "d:\BKN2\OUT\Agency\"
        '
        'Label3
        '
        ...
        Me.txtTemplate.Text = "d:\BKN2\blocks\template%TYPE%.htm"
        '
        'Label6
        '
        ...
        Me.txtTemplateJS.Text = "d:\bkn2\blocks\template.js"
        '
        'Label7
        '
        ...
        Me.txtTabTemplate.Text = "d:\BKN2\blocks\tabtemplate%TYPE%.php"
        '
        'Label8
        '
        ...
        Me.txtCardTemplate.Text = "d:\BKN2\blocks\cardtemplate%TYPE%.php"
        '
        'frmB2Sercher
        '
