...
Public Class frmB2Sercher
    ...
    Private Function GetCompany() As String
        ...
        reg = Manager.Session.GetData("select sscli_Defid,name from sscli_Def order by name")
        For i = 0 To reg.Rows.Count - 1
            sw.Append(vbCrLf & "   <option value=""" & reg.Rows(i)("sscli_Defid").ToString() & """>" & reg.Rows(i)("name") & "</option>")
            ...
            ElseIf fld.ReferenceType = MTZMetaModel.MTZMetaModel.enumReferenceType.ReferenceType_Na_stroku_razdela Then
                ...
                If Not refP Is Nothing Then
                    ...
                    If refP.Name.ToLower <> "b2g_addr" Then
                        ...
                        rs = Manager.Session.GetData(" select " + refP.Name + "id id, dbo." + refP.Name + "_BRIEF_F(" + refP.Name + "." + refP.Name + "Id, NULL) Brief from " + refP.Name)
